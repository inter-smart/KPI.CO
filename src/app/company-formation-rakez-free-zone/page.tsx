...
const localData = {
  ...
  mainlandBusiness: {
    ...
    footerDescription:
      "RAKEZ empowers business owners to focus on growth, offering a strong foundation for sustainable success in the UAE and across the Middle East.",
    image: {
  ...
  document_required_data: {
    ...
    items: [
      ...
      {
        id: 2,
        text: "Regulatory and compliance guidance tailored to RAKEZ requirements",
      },
      { id: 3, text: "Corporate governance support to streamline operations" },
      {
        id: 4,
        text: "Risk assessment and advisory for secure expansion Ongoing post‑setup services including licences, visas, and approvals",
      },
    ],
