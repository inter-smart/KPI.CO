...
const localData = {
    ...
    services: {
        ...
        footer_description: "Each service is delivered with independence, professional scepticism, and a clear understanding of regulatory expectations. Aligned with ISA, supported by ISQM-based quality controls, and applied consistently across engagements",
    },
    mainlandBusiness: {
        title: "How KPI Approaches Audit",
        description:
            "<p><b>Disciplined without unnecessary disruption</b></p>",
    ...
    whyChoose: {
        ...
        description:
            "<p>Here’s where we’re diplomatic but strong:</p>",
        sub_title: "",
        items: [
            {
                id: 1,
    ...
    return (
        <>
            ...
            <CorporateServicesUaeServices
                ...
                variant="saifz"
            />
            <MainlandBusiness data={localData.mainlandBusiness} variant="AuditServicesUae" />
            <CorporateServicesUaeWhyBuild data={localData.whyBuild} variant="AuditServicesUae" />
            ...
            <CorporateServicesUaeCta data={localData.cta} variant="AuditServicesUae" />
