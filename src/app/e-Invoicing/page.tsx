...
const localData = {
    ...
    formationProcess: {
        ...
        sub_title: null,
        description: "Our e-invoicing support is advisory-led, with a focus on tax outcomes, control integrity, and regulatory defensibility.",
        steps: [
            {
                id: 1,
        ...
        free_zone_list: [
            {
                ...
                description:
                    "How E-Invoicing Improves Accuracy and Control",
                highlightsText: "When implemented with the right structure and controls, e-invoicing delivers measurable operational benefits:",
                zone_list: [
