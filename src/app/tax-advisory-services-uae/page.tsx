...
const localData = {
    ...
    free_zone_list: [
      {
        ...
        highlightsText: "Our work typically covers:",
        zone_list: [
  ...
  document_required_data: {
    ...
    items: [
      {
        id: 1,
        text: "Entering the scope of UAE corporate tax or reassessing tax positions ",
      },
      { id: 2, text: "Launching new revenue streams or business lines " },
      {
        id: 3,
        text: "Group restructurings, acquisitions or ownership changes ",
      },
      { id: 4, text: "Cross-border payments or intercompany arrangements " },
      { id: 5, text: "Board or investor scrutiny on tax exposure " },
      {
        id: 6,
        text: "Preparing for audit, due diligence, or regulatory review  ",
      },
    ],
