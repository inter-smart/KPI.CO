...
import AdvisorySerice, {
  AdvisoryData,
} from "@/components/features/advisory/AdvisorySerice";
import AdvisoryProservice, {
  ProserviceItem,
} from "@/components/features/advisory/AdvisoryProservice";
...
const localData = {
  ...
  document_required_data: {
    ...
    description:
      "<p>Advisory is not a one-time decision. It evolves as organisations grow, restructure, expand into new jurisdictions, or face changing regulatory requirements. Our advisory services are designed to support organisations at different stages, including:  </p>",
    items: [
    ...
    cards: [
      {
        ...
        description:
          "Under our Corporate Services practice, KPI supports businesses with entity formation and structuring across key UAE jurisdictions.",
        sections: [
          {
          ...
          {
            title:
              "Within ADGM, we also advise on advanced structuring solutions, including:",
            items: [
        ...
        footer:
          "Our role goes beyond incorporation. We help clients select the right jurisdiction, structure ownership appropriately, and design governance frameworks aligned with regulatory expectations and long-term objectives.",
        button: {
      ...
      },
      {
        ...
        description:
          "The UAE tax landscape now requires active management. Corporate tax, VAT, and e-invoicing obligations demand accuracy, consistency, and timely compliance.",
        sections: [
          {
        ...
        footer:
          "Our tax advisory services are designed to help organisations understand their obligations, implement compliant processes, and manage tax matters with confidence — without unnecessary complexity.",
        button: {
          label: "Explore Services",
  ...
  riskAdvisory: {
    ...
    highlightsText:
      "Relocation support is delivered as part of a wider advisory engagement, ensuring personal and business requirements are addressed cohesively. ",
    advisoryItems: [
      {
        id: 1,
        slNo: 1,
        description: "Residence and dependent visas ",
      },
      {
        id: 2,
        slNo: 2,
        description: "Education and school-related guidance ",
      },
      {
        id: 3,
        slNo: 3,
        description: "Banking introductions and account support ",
      },
      {
        id: 4,
        slNo: 4,
        description: "Coordination of essential documentation  ",
      },
    ],
  ...
  Proservice: {
    ...
    footer_description:
      "<p> Our PRO support is integrated with our advisory services, ensuring operational requirements remain aligned with regulatory and structural considerations.</p> ",
    items: [
      {
        id: 1,
        media: {
        ...
        title:
          "Trade License Renewals <br className='hidden sm:block' /> And Amendments",
      },
      {
        id: 2,
        media: {
        ...
        title:
          "Immigration And Visa <br className='hidden sm:block' /> Processing",
      },
      {
        id: 3,
        media: {
        ...
        title:
          "Labour And Establishment <br className='hidden sm:block' /> Card Services",
      },
      {
        id: 4,
        media: {
        ...
        title:
          "Government Approvals And <br className='hidden sm:block' /> Submissions",
      },
