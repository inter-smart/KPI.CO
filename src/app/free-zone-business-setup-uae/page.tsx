...
export default function page() {
    return (
        <>
            ...
            <DocumentRequired data={localData.document_required_data} variant="freezone-business" />
            <CorporateServicesUaeBanking data={localData.banking} variant="freezone-business" />
            <CorporateServicesUaeWhyChoose variant="freezone-business" data={localData.whyChoose} />
