...
const localData = {
  ...
  mainlandBusiness: {
    ...
    description:
      "<p>A mainland company lets you do business anywhere in the UAE, without being limited to a specific free zone. It is licensed by the Department of Economic Development (DED) in the Emirate where your company is registered and is commonly used by businesses that want direct access to the local market.</p>",
    highlightsTitle:
      "Mainland company formation is suitable for businesses such as:",
    highlights: [
      "Trading companies",
    ...
    image: {
      path: "/images/mainlandBusineesuae.jpg",
