...
export const headingVariants = cva("leading-tight font-semibold", {
  variants: {
    size: {
      h1: "text-[28px] lg:text-[32px] lg:text-[34px] xl:text-[48px] 2xl:text-[52px] 3xl:text-[65px] leading-[1.4]",
      h2: "text-[28px] sm:text-[28px] lg:text-[32px] xl:text-[38px] 2xl:text-[40px] 3xl:text-[50px] leading-[1.4]",
      h3: "text-[28px] sm:text-[28px] lg:text-[34px] xl:text-[38px] 2xl:text-[40px] 3xl:text-[48px]",
