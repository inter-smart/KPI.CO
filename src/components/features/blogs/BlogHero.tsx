...
export default function BlogHero({ data }: BlogHeroProps) {
  return (
    <section className="relative h-[375px]  sm:h-[230px] xl:h-[327px] 2xl:h-[350px] 3xl:h-[440px]   w-full flex items-center overflow-hidden">
      {/* Background Gradient */}
      ...
      <div className="container relative z-20 ">
        <div className="max-w-[630px] xl:max-w-[770px] max-sm:text-center">
          <Heading
            as="h1"
            size="h1"
            className="xl:text-[48.83px] text-white font-bold mb-6 !leading-[1.1] "
          >
            {data.title}
          </Heading>
