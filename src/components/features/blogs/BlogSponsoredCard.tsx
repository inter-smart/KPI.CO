...
export default function BlogSponsoredCard({ data }: SponsoredCardProps) {
  return (
    <div className="w-full rounded-[16px] bg-white  border border-[#e6edf5] shadow-[0_12px_30px_rgba(16,24,40,0.12)] overflow-hidden">
      <div className="text-[12px] 2xl:text-[14px] 3xl:text-[16px] tracking-[0.24em] font-normal text-white uppercase px-[16px] py-[10px] bg-gradient-to-r from-[#3EB0EA] to-[#1768AB] ">
      ...
      <div className="p-[20px]">
        <div className="relative w-full aspect-[16/9] rounded-[12px] overflow-hidden bg-[#0b1220]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="h-[55px] xl:h-[65px] 2xl:h-[75px] 3xl:h-[85px] w-[55px] xl:w-[65px] 2xl:w-[75px] 3xl:w-[85px] rounded-full bg-white flex items-center justify-center shadow-[0_10px_25px_rgba(15,23,42,0.25)]">
              <Image
                src="/images/playicon.svg"
                alt="about-delemt"
                width={24}
                height={25}
                className="w-[16px] xl:w-[18px] 2xl:w-[20px] 3xl:w-[24px] h-auto object-contain ml-[2px]"
              />
            </span>
          </div>
        ...
        <Button
          className="text-[14px] xl:text-[16px] 2xl:text-[20px] leading-none font-medium text-[#212121] w-full h-[42px] 2xl:h-[50px] bg-[#ffc916] rounded-[10px] mt-[20px]"
          asChild
        >
