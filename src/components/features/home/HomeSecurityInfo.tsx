        ...
        <div className="sm:[--width:260px] xl:[--width:363px]  flex flex-wrap max-lg:gap-4 max-sm:flex-col-reverse">
          ...
          <div className="w-full max-sm:max-w-full max-xl:max-w-[50%] max-xl:m-auto xl:w-[var(--width)]">
            ...
            <div className="text-center w-full h-auto p-[40px] lg:p-[40px_30px] xl:p-[46px_36px_44.9px_34px]  rounded-[9.35px] shadow-[0px_2px_16px_0px_rgba(0,0,0,0.1)] overflow-hidden">
              ...
              <div className="text-[21.98px] lg:text-[22px] xl:text-[24.93px] 3xl:text-[34px] leading-[29.9px] font-bold text-[#1C5396] mb-[5px]">
                {data.isoInfo.label}
              </div>
              <div className="text-[12px] xl:text-[12.46px] 2xl:text-[14px] 3xl:text-[16px] leading-[18.7px] font-semibold text-[#4E4E4E] w-auto h-auto pb-1.25 2xl:pb-2 mb-[10px]  relative z-0 inline-flex before:content-[''] before:w-full before:h-[2px] before:bg-linear-to-t before:from-[#3EB0EA] before:to-[#1C5396] before:absolute before:z-1 before:inset-[auto_0_0_0]">
                Certified
              </div>
              <div className="text-[11.91px] lg:text-[12px] xl:text-[13.51px] 3xl:text-[18px] leading-[20.3px] font-medium text-[#4E4E4E] max-sm:max-w-[256.57px] max-sm:m-auto p-[20px_15px] lg:p-[15px_25px] xl:p-[16px_24px] 3xl:p-[25px_30px] bg-[#F8F9FB] rounded-[10px] overflow-hidden">
