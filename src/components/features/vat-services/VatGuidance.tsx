...
interface VatGuidanceProps {
  ...
  variant?: "default" | "Financial-Statement-Audit";
}
  ...
  return (
    <section className="w-full h-auto py-[40px_50px] sm:py-[70px_50px] xl:py-[80px_60px] 2xl:py-[100px_70px] 3xl:py-[120px_80px] block">
      <div className="container">
        <div
          className={cn(
            "[--image-size:100%] md:[--image-size:320px] lg:[--image-size:370px] xl:[--image-size:450px] 2xl:[--image-size:550px] 3xl:[--image-size:680px] flex flex-wrap",
