        ...
        >
          ...
          >
            <div className="w-full h-auto block">
              ...
              <div className="text-[16px] xl:text-[18px] 2xl:text-[20px] 3xl:text-[24px] leading-[1.8] font-normal text-[#4E4E4E] xl:pr-[40px] mb-[25px] sm:mb-[20px] xl:mb-[25px] 2xl:mb-[30px] 3xl:mb-[40px]">
                {data?.description}
              </div>
              <div className="text-[16px] xl:text-[18px] 2xl:text-[20px] 3xl:text-[24px] leading-normal font-normal text-[#4E4E4E] mb-[25px] sm:mb-[20px] xl:mb-[25px] 2xl:mb-[30px] 3xl:mb-[40px]">
