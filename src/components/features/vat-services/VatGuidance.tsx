...
export type VatGuidanceData = {
  ...
  footer_highlighted_text?: string;
  service_list: string[];
  media: {
    path: string;
    alt: string;
...
export default function VatGuidance({
  data,
  variant = "default",
}: VatGuidanceProps) {
  return (
    <section
      className={cn(
        "w-full h-auto py-[20px] sm:py-[70px_50px] xl:py-[80px_60px] 2xl:py-[100px_70px] 3xl:py-[120px_80px] block",
        ...
        <div
          className={cn(
            ...
            variant === "Financial-Statement-Audit" &&
              "xl:[--image-size:514px] mb-[25px] xl:mb-[30px] 3xl:mb-[40px]",
            variant === "VatServicesUae" && "xl:[--image-size:514px]",
          )}
        >
          <div
            className={cn(
              "w-full md:w-[calc(100%-var(--image-size))] md:pr-[20px] xl:pr-[25px] 2xl:pr-[30px] 3xl:pr-[40px]",
              variant === "VatServicesUae" && "xl:pr-[30px]",
              variant === "Financial-Statement-Audit" && "xl:pr-[28px]",
            )}
          >
            <div className="w-full h-auto block">
              <Heading
                as="h2"
                size="h2"
                className="text-[#1C5396] mb-[30px] sm:mb-[20px] xl:mb-[23px] 2xl:mb-[30px] 3xl:mb-[40px] xl:pr-[70px] leading-[150%]"
              >
                {data?.title}
              </Heading>
              <div className="w-full h-auto max-sm:h-[378px] aspect-[330/375] mb-[23px] rounded-[10px] overflow-hidden block md:hidden">
                <Image
              ...
              <div className="text-[16px] xl:text-[18px] 2xl:text-[20px] 3xl:text-[24px] leading-[150%] font-normal text-[#4E4E4E] xl:pr-[40px] mb-[25px] sm:mb-[20px] xl:mb-[25px] 2xl:mb-[30px] 3xl:mb-[40px]">
                {data?.description}
              </div>
              <div className="text-[16px] xl:text-[18px] 2xl:text-[20px] 3xl:text-[24px] leading-[150%] font-normal text-[#4E4E4E] mb-[25px] sm:mb-[20px] xl:mb-[25px] 2xl:mb-[30px] 3xl:mb-[40px]">
          ...
          <div className="w-[var(--image-size)] max-md:hidden">
            <div
              className={cn(
                "w-full h-full sm:rounded-[10px] xl:rounded-[12px] xl:h-[675px] overflow-hidden block",
                variant === "Financial-Statement-Audit" && "xl:h-[608px]",
              )}
            >
              <Image
                src={data?.media?.path || "images/placeholder.png"}
                ...
                className={cn(
                  ...
                  variant === "Financial-Statement-Audit" && "xl:h-full",
                )}
              />
            </div>
          </div>
        </div>
        {data?.footer_highlighted_text && (
