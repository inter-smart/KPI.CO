        ...
        >
          <div className="flex touch-pan-y touch-pinch-zoom">
            {data?.service_list?.map((item) => (
              ...
              >
                <div className={cn("w-full h-full  p-[30px_20px] sm:p-[25px_20px] xl:p-[30px_20px] 2xl:p-[35px_25px] 3xl:p-[40px_30px] bg-white rounded-[14px] xl:rounded-[12px] 2xl:rounded-[20px] border-1 border-black/10 overflow-hidden flex flex-col", variant === "VatServicesUae" && "xl:p-[31px_22px_30px]")}>
