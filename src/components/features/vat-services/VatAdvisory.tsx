...
export default function VatAdvisory({ data }: VatAdvisoryProps) {
  ...
  return (
    <section className="w-full h-auto py-[45px_40px] sm:py-[35px_50px] xl:py-[40px_60px] 2xl:py-[50px_70px] 3xl:py-[60px_90px] bg-[#F9FAFB] max-sm:rounded-[20px] overflow-hidden block">
      <div className="container">
        <div className="w-full h-auto mb-[30px] xl:mb-[40px] 3xl:mb-[50px]">
          ...
          <div className="text-[16px] xl:text-[18px] 2xl:text-[20px] 3xl:text-[24px] leading-[1.8] font-normal text-[#4E4E4E]">
            {data?.description}
          </div>
        </div>
        <div
