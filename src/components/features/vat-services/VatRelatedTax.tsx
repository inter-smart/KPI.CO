...
interface VatRelatedTaxProps {
  ...
  variant?: "sop" | "default" | "regulatory" | "AuditServicesUae";
}
        ...
        <div className="w-full h-auto mb-[25px] sm:mb-[30px] xl:mb-[35px] 2xl:mb-[40px] 3xl:mb-[50px]">
          <Heading
            ...
            className={cn(
              ...
              variant === "AuditServicesUae" && "max-sm:text-[26px]",
            ...
            {data?.tax_list?.map((item) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={cn(
                      "text-[24px] sm:text-[18px] xl:text-[24px] 2xl:text-[25px] 3xl:text-[32px] leading-normal font-medium text-white w-full h-full relative z-2 flex items-end [&>br]:!block",
                      variant === "regulatory" && "max-sm:text-[26px]",
                    )}
                  >
