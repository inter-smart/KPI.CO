  ...
  return (
    <section className="w-full h-auto py-[45px_40px] sm:py-[35px_50px] xl:py-[40px_60px] 2xl:py-[50px_70px] 3xl:py-[70px_100px] block">
      <div className="container">
        <div className="[--image-size:100%] lg:[--image-size:360px] xl:[--image-size:510px] 2xl:[--image-size:550px] 3xl:[--image-size:680px] p-[30px_15px_50px_15px] sm:p-[15px_35px_15px_25px] xl:p-[20px_50px_20px_35px] 3xl:p-[30px_70px_30px_40px] bg-gradient-to-tl from-[#fefdf1] to-white rounded-[15px] sm:rounded-[10px] xl:rounded-[15px] 2xl:rounded-[20px] border-2 border-[#FFCB18] overflow-hidden flex flex-wrap">
          <div className="w-[var(--image-size)] lg:w-[calc(100%-var(--image-size))] lg:pr-[20px] xl:pr-[120px] 2xl:pr-[140px] 3xl:pr-[175px] max-lg:mb-[30px]">
            <div className="w-full h-auto mb-[15px] sm:mb-[20px] 2xl:mb-[25px] 3xl:mb-[30px]">
              <Heading
                as="h2"
                size="h2"
                className="text-[#1C5396] mb-[15px] xl:mb-[18px]"
              >
                {data?.title}
              </Heading>
              <div className="text-[16px] xl:text-[18px] 2xl:text-[20px] 3xl:text-[24px] leading-normal font-normal text-[#364153] [&_b]:font-medium [&_p]:mb-[10px] xl:[&_p]:mb-[15px] 3xl:[&_p]:mb-[20px]">
                {data?.description}
              </div>
            </div>
            <ul className="space-y-3.75 lg:space-y-4.5 2xl:space-y-5 mb-[25px] sm:mb-[20px] xl:mb-[35px] 2xl:mb-[50px]">
              {data?.health_list.map((item, index) => (
                <li
                  key={index}
                  className="text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-[#364153] pl-[25px] mb-[10px] xl:mb-[13px] 3xl:mb-[23px] relative"
                >
                  <span className="absolute inset-0 w-[16px] h-[16px] right-auto top-[3px]">
                    <Image
