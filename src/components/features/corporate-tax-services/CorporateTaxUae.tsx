...
export default function CorporateTaxUae({
  ...
  return (
    <section className="w-full h-auto py-[20px] sm:py-[40px_50px] xl:py-[50px_60px] 2xl:py-[50px_60px] 3xl:py-[60px_80px] block">
      <div className="container">
        <div
          className={cn(
            "w-full h-auto p-[30px_15px] sm:p-[35px_25px] xl:p-[50px_45px_35px] 2xl:p-[50px_40px] 3xl:p-[70px_50px] border-2 rounded-[15px] 2xl:rounded-[20px] xl:min-h-[365px] overflow-hidden block",
            variant === "blue"
              ? "bg-gradient-to-br from-white to-[#EFF6FF] border-[#1C5396]"
              : "bg-gradient-to-br from-white to-[#FFFBEB] border-[#F0C21A]",
          )}
        >
          <div className="text-[28px] xl:text-[38px] 2xl:text-[40px] 3xl:text-[50px] leading-normal font-semibold text-[#1C5396] mb-[25px] xl:mb-[30px] 2xl:mb-[35px] 3xl:mb-[50px]">
            {data?.title}
          </div>
            ...
            {data?.tax_list?.map((item, index) => (
              ...
              >
                <div className="w-full h-full">
                  <div className="text-[14px] xl:text-[16px]  leading-[150%]  font-medium text-[#053269] mb-[15px] xl:mb-[15px]">
                    {item?.title}
                  </div>
                  {item?.description && (
                    <div className="text-[14px] xl:text-[16px]  leading-[150%]  font-normal text-[#4E4E4E]">
                    ...
                    <ul >
                      {item?.items.map((item, index) => (
                        <li
                          key={index}
                          className={cn(
                            "w-full h-auto pl-[30px] sm:pl-[25px] xl:pl-[25px] 2xl:pl-[35px] 3xl:pl-[40px] mb-[10px] last-of-type:mb-0 relative z-0 before:content-[''] before:w-[20px] sm:before:w-[16.67px] xl:before:w-[16.67px] 3xl:before:w-[25px] before:aspect-square before:bg-no-repeat before:bg-contain before:absolute before:left-0 before:top-[4px] ",
                            variant === "blue"
                        ...
                        >
                          <span className="text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[20px] leading-[150%] font-normal text-[#4E4E4E] tracking-[-0.31px]">
                            {parse(item)}
                          </span>
                        </li>
                      ))}
