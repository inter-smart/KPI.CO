...
export default function CorporateTaxUae({
  ...
  return (
    <section className="w-full h-auto py-[40px] sm:py-[40px_50px] xl:py-[50px_60px] 2xl:py-[50px_60px] 3xl:py-[60px_80px] block">
      <div className="container">
        <div
          className={cn(
            "w-full h-auto p-[30px_15px] sm:p-[35px_25px] xl:p-[50px_35px] 2xl:p-[50px_40px] 3xl:p-[70px_50px] border-2 rounded-[15px] 2xl:rounded-[20px] overflow-hidden block",
            variant === "blue"
                  ...
                  {item?.items && (
                    <ul className="space-y-[10px] xl:space-y-[15px] 3xl:space-y-[25px]">
                      {item?.items.map((item, index) => (
                        ...
                        >
                          <span className="text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[20px] leading-normal font-normal text-[#4E4E4E]">
                            {parse(item)}
                          </span>
                        </li>
                      ))}
