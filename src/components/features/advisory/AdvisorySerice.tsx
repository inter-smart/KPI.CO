                        ...
                        >
                            <Heading
                                ...
                                size="h2" className={cn(
                                    "text-[28px] lg:text-[27px] xl:text-[38px] 2xl:text-[40px] 3xl:text-[50px] text-[#1C5396] font-medium !mb-[20px] xl:!mb-[25px] 2xl:!mb-[30px] 3xl:!mb-[35px]",
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2  gap-10 mb-[20px] xl:mb-[25px] 2xl:mb-[30px] 3xl:mb-[40px]">
                                {card.sections.map((section, idx) => (
                                    <div key={idx} className="flex flex-col max-lg:border-t lg:border-l border-[#DEDEDE] max-lg:pt-[15px] lg:pl-[95px] first-of-type:lg:border-none lg:first-of-type:p-0">
                                        <div className="text-[14px] lg:text-[12px] xl:text-[16px] 2xl:text-[17px] 3xl:text-[21px] text-[#053269] font-medium mb-[20px]">
                                            {section.title}
                                        </div>
                                        <ul>
                                            {section.items.map((item, itemIdx) => (
                                                <li key={itemIdx} className="flex items-start mb-[12px]">
                                                    <div className="w-[20px] xl:w-[20px] 2xl:w-[21px] 3xl:w-[26px] h-[20px] xl:h-[20px] 2xl:h-[21px] 3xl:h-[26px]">
                                                    ...
                                                    <span className="text-[#4E4E4E] text-[14px] xl:text-[16px] 2xl:text-[17px] 3xl:text-[21px] pl-[10px] block w-[calc(100%-20px)] 2xl:w-[calc(100%-21px)] 3xl:w-[calc(100%-26px)] leading-snug">
                                                        {item}
                                                    </span>
                                                </li>
                                            ))}
                            ...
                            <p className="text-[#4E4E4E] text-base lg:text-lg xl:text-[18px] 2xl:text-xl 3xl:text-2xl mb-10 lg:mb-14 leading-relaxed font-normal">
                                {card.footer}
                            </p>
                            ...
                            <Link
                                ...
                                className={cn(
                                    "text-[16px] xl:text-[16px] 2xl:text-[17px] 3xl:text-[21px] inline-flex items-center justify-center px-12 py-3 h-[48px] rounded-[10px] font-medium transition-all",
