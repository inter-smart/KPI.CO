                ...
                <ul className="space-y-[10px] xl:space-y-[15px] 3xl:space-y-[25px]">
                  {item?.zone_list?.map((zone, i) => (
                    <li
                      key={i}
                      className={cn(
                        "w-full h-auto pl-[30px] sm:pl-[25px] xl:pl-[32px] 2xl:pl-[35px] 3xl:pl-[40px] relative z-0 before:content-[''] before:w-[20px] sm:before:w-[18px] 2xl:before:w-[20px] 3xl:before:w-[25px] before:aspect-square before:bg-no-repeat before:bg-contain before:absolute before:left-0 before:top-[4px]",
                        index % 2 !== 0
