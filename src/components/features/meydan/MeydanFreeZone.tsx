        ...
        <div
          className={cn(
            ...
            (variant === "difc" || variant === "holding" || "difc-regulated") &&
              "xl:grid-cols-1",
            variant === "regulatory" && "xl:grid-cols-1",

            variant === "ADGM-Foundation" &&
              "sm:gap-[15px] lg:gap-[20px] xl:gap-[32px] 2xl:gap-[35px] 3xl:gap-[40px] xl:grid-cols-2 ",

            variant === "ifza" &&
              "sm:gap-[15px] lg:gap-[20px] xl:gap-[32px] 2xl:gap-[35px] 3xl:gap-[40px]",
            variant === "MeydanFreeZone" &&
              "sm:gap-[15px] lg:gap-[20px] xl:gap-[30px] xl:grid-cols-2",
          ...
          {data?.free_zone_list?.map((item, index) => (
            <div key={item?.id} className="w-full h-auto">
              ...
              >
                ...
                <ul className={cn("mb-[20px]", variant === "ifza" && "mb-0")}>
