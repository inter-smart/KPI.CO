...
export default function MeydanFreeZone({ data }: MeydanFreeZoneProps) {
  if (!data) return null;
            ...
            return (
              <div key={item?.id} className="w-full h-auto">
                ...
                >
                  ...
                  <ul className="w-full h-auto space-y-[10px] xl:space-y-[15px] 3xl:space-y-[25px]">
                    {item?.zone_list?.map((item, index) => (
                      <li
                        key={index}
