    ...
    return (
        <section className='w-full h-auto py-[45px_40px] sm:py-[35px_50px] xl:py-[45px_70px] 2xl:py-[55px_80px] 3xl:py-[70px_100px] block'>
            <div className="container">
                <div className="w-full h-auto mb-[25px] sm:mb-[20px] 2xl:mb-[25px] 3xl:mb-[35px]">
                    <Heading
                        as="h2"
                        size="h2"
                        className="text-[#1C5396] mb-[30px] lg:mb-[20px] 2xl:mb-[30px] 3xl:mb-[40px]"
                    >
                        {data?.title}
                    </Heading>
                                ...
                                <div className="w-full h-full rounded-[18px] border border-black/10 overflow-hidden block">
                                    ...
                                    <div className="w-full h-auto p-[25px] sm:p-[15px] xl:p-[20px] 2xl:p-[25px] 3xl:p-[30px] flex flex-col justify-between">
                                        ...
                                        <Link
                                            ...
                                            className="text-[16px] sm:text-[14px] xl:text-[15px] 2xl:text-[18px] 3xl:text-[22px] leading-normal font-semibold text-[#3570B8] transition-opacity duration-200 hover:opacity-70"
                                        >
                                            Learn more →
                                        </Link>
                                    </div>
