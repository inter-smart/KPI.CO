  ...
  return (
    ...
    >
      <div className="container max-sm:px-[16.1px]">
        <div
          className={cn(
            "w-full md:max-w-[1069px] h-auto mx-auto rounded-[20px] overflow-hidden relative z-0 flex flex-wrap items-center max-sm:flex-col max-sm:justify-center",
            variant === "mainland"
            ...
            variant === "e-invoicing"
              ? "max-sm:!p-[40px_21px_37px_31px] sm:p-[35px] xl:p-[45px] 2xl:p-[55px] 3xl:p-[70px] xl:min-h-[289px] bg-gradient-to-t from-[#053269] via-[#5596CA] to-[#3EB0EA]"
              : "p-[50px_30px] lg:p-[60px_45px] xl:p-[54.9px_52px] 2xl:p-[70px_50px] 3xl:p-[90px_70px] bg-linear-to-t from-[#6A9FE0] to-[#053269]",
            variant === "CorporateTaxUae"
            ...
            variant === "Offshore" &&
              "max-sm:p-[44px_21px_47px_30px] xl:p-[45px_50px] xl:min-h-[289px]",
            variant === "rakez" && "xl:p-[45px_50px] xl:min-h-[289px]",
            variant === "Formation-ADGM" &&
              "px-[31px_21px] xl:p-[45px_52px] min-h-[265px] xl:min-h-[289px] max-sm:max-w-[343px]",
            variant === "dwtc" &&
