                        ...
                        {data?.faq_list?.map((item) => (
                            <AccordionItem
                                ...
                                <AccordionTrigger className="py-4 sm:py-5 lg:py-7 2xl:py-8.75 3xl:py-10 [&>svg]:text-[#1C5396] [&>svg]:w-5 2xl:[&>svg]:w-7.5 [&>svg]:h-5 2xl:[&>svg]:h-7.5">
                                    <div className="text-[16px] lg:text-[18px] 2xl:text-[21px] 3xl:text-[26px] leading-[1.4] font-medium text-black max-w-[90%]">{item?.title}</div>
                                </AccordionTrigger>
                                <AccordionContent className="pb-3.75 sm:pb-6.25">
                                    <div
                                        className="typography [&_p]:text-[14px] 2xl:[&_p]:text-[18px] 3xl:[&_p]:text-[21px] [&_p]:leading-[1.8] [&_p]:font-normal [&_p]:text-black [&_p]:last:my-0 mb-0 max-w-[90%]"
                                    >
