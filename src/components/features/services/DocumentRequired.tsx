    ...
    <section
      className={cn(
        ...
        variant === "MeydanFreeZone" &&
          "bg-linear-to-t from-[rgba(62,176,234,0.06)] via-white to-white sm:bg-[#F9FAFB]",
        variant === "dmcc" &&
          "bg-linear-to-t from-[rgba(62,176,234,0.06)] via-white to-white sm:bg-[#F9FAFB]",
        variant === "AuditServicesUae" &&
          "bg-linear-to-t from-[#f5fbfe] via-white to-white xl:py-[90px_50px]",
        variant === "AuditServicesUaes" && "bg-white xl:py-[90px_50px]",
        ...
        <div className="flex max-md:flex-col-reverse max-md:flex-wrap">
          ...
          <div
            className={cn(
              ...
              variant === "AuditServicesUae" &&
                "xl:w-[calc(100%-473px)] xl:pr-[48px]",
              variant === "internal-audit" &&
                "xl:w-[calc(100%-473px)] xl:pr-[10px]",
            ...
            {(data?.title || data?.description) && (
              <div
                className={cn(
                  ...
                  variant === "internal-audit" && "md:pr-[30px] xl:pr-[30px]",
                )}
              >
                <div
                  className={cn(
                  ...
                  <div
                    className={cn(
                      ...
                      variant === "AuditServicesUaes" &&
                        "[&_b]:text-[16px] sm:[&_b]:text-[18px] lg:[&_b]:text-[20px] xl:[&_b]:text-[24px] [&_b]:font-semibold",
                      variant === "internal-audit" &&
                        "leading-relaxed xl:[&_p]:mb-[30px] [&_p:last-of-type]:mb-0",
                    )}
                  >
                ...
                {items.map((item) =>
                  item.type === "heading" ? (
                    ...
                    >
                      <span
                        className={cn(
                          "absolute inset-0 w-[16px] xl:w-[20px] xl:h-[20px] 3xl:w-[23px] h-[16px] 3xl:h-[23px] top-[3.5px] xl:top-[4.5px] bottom-0 left-0 right-auto",
                          variant === "CorporateTaxUae" && "xl:top-[4px]",
                        )}
                      >
