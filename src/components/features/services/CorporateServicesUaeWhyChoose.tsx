    ...
    >
      <div className="container">
        ...
        >
          ...
          {data?.description && (
            <div className="text-[16px] xl:text-[22px] 2xl:text-[20px] 3xl:text-[24px] leading-normal font-normal text-[#4E4E4E] max-sm:[&_br]:hidden [&_b]:font-semibold [&_b]:text-black [&_b]:block [&_b]:mt-[20px] sm:[&_b]:mt-[30px]">
        ...
        {variant === "mainland" && (
          <div ref={emblaRef} className="w-full max-w-full block sm:hidden">
            ...
            <div className="flex justify-center items-center mt-6 gap-[20px] md:gap-[30px] sm:hidden">
