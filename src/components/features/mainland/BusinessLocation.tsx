        ...
        <section className="w-full py-[35px] xl:py-[50px] 2xl:py-[70px] 3xl:py-[110px] bg-white">
            <div className="container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 2xl:gap-8">
                    {data.items.map((item) => (
                        <div key={item.id} className="group relative min-h-[210px] 2xl:min-h-[260px] 3xl:min-h-[310px] rounded-[10px] shadow-[0px_4px_6px_rgba(0,0,0,0.1)] overflow-hidden shadow-md">


                            <div className="absolute top-0 left-0 h-full w-full transition-opacity duration-500 ease-in-out group-hover:opacity-0 group-hover:pointer-events-none aspect-[500/312]">
                                <Image
