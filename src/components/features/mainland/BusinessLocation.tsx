                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 2xl:gap-8">
                    {data.items.map((item) => (
                        <div key={item.id} className="group relative min-h-[210px] 2xl:min-h-[260px] 3xl:min-h-[310px] rounded-[10px] shadow-[0px_4px_6px_rgba(0,0,0,0.1)] overflow-hidden shadow-md">
                            ...
                            <div className="relative  h-full w-full inset-0 bg-[#E2F5FF] p-[30px] 3xl:p-[35px] flex flex-col opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:scale-100 scale-95 origin-center pointer-events-none group-hover:pointer-events-auto">
