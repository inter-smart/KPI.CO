            ...
            <div key={item?.id} className="w-full h-auto block">
              <div className="group [--icon-size:45px] lg:[--icon-size:40px] xl:[--icon-size:44px] 2xl:[--icon-size:45px] 3xl:[--icon-size:58px] w-full h-full p-6.25 lg:p-5 xl:p-[25px] 2xl:p-6.25 3xl:p-7.5 max-sm:pr-[10px] bg-white rounded-[10px] sm:rounded-[8px] 2xl:rounded-[10px] border-1 border-[#E2E2E2] flex">
                ...
                <div className="w-[calc(100%-var(--icon-size))] pl-3.75 lg:pl-3 xl:pl-[20px] 2xl:pl-3.75 3xl:pl-5">
                  <div className="text-[18px] lg:text-[20px] xl:text-[22px] 2xl:text-[24px] 3xl:text-[30px] leading-normal font-medium text-[#1C5396] capitalize mb-[10px]">
                    {item?.title}
                  </div>
                  ...
                  <div key={item?.id} className="w-full h-auto block">
                    <div className="group [--icon-size:45px] lg:[--icon-size:40px] 2xl:[--icon-size:45px] 3xl:[--icon-size:60px] w-full h-full p-6.25 lg:p-5 2xl:p-6.25 3xl:p-7.5 max-sm:pr-[10px] bg-white rounded-[10px] sm:rounded-[8px] 2xl:rounded-[14px] border-1 border-[#E2E2E2] flex">
                      ...
                      <div className="w-[calc(100%-var(--icon-size))] pl-3.75 lg:pl-3 2xl:pl-3.75 3xl:pl-5">
                        <div className="text-[18px] lg:text-[20px] xl:text-[22px] 2xl:text-[24px] 3xl:text-[30px] leading-normal font-medium text-[#1C5396] capitalize mb-[10px] 3xl:mb-3">
                          {item?.title}
                        </div>
                        <p className="text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[22px] leading-normal font-normal text-[#4E4E4E]">
                          {item?.description}
                        </p>
                      </div>
                    </div>
