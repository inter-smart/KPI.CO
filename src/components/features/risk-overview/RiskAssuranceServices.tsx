      ...
      <div className="container">
        <div className="w-full mb-6.25 lg:mb-8.75 2xl:mb-10 3xl:mb-12.5">
          <Heading
            as="h2"
            size="h2"
            className="text-[#1C5396] mb-25px] xl:mb-[35px]"
          >
            {data?.title}
          </Heading>
        ...
        <div className="hidden sm:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5.5 lg:gap-6.25 xl:gap-[30px] 2xl:gap-7.5 3xl:gap-9">
          {data.items.map((item) => (
            <div key={item?.id} className="w-full h-auto block">
              <div className="group [--icon-size:45px] lg:[--icon-size:40px] xl:[--icon-size:44px] 2xl:[--icon-size:45px] 3xl:[--icon-size:58px] w-full h-full p-6.25 lg:p-5 2xl:p-6.25 3xl:p-7.5 max-sm:pr-[10px] bg-white rounded-[10px] sm:rounded-[8px] 2xl:rounded-[10px] border-1 border-[#E2E2E2] flex">
