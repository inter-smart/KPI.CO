          ...
          <div className="w-full lg:w-[calc(100%-395px)] xl:w-[calc(100%-510px)] 3xl:w-[calc(100%-680px)] lg:pr-[30px]">
            <div className="w-full">
              <Heading
                as="div"
                size="h3"
                className="lg:text-[27px] xl:text-[33px] 2xl:text-[40px] 3xl:text-[50px] font-semibold text-[#1C5396] capitalize max-w-[94%] !mb-[20px] xl:!mb-[25px] 2xl:!mb-[30px] 3xl:!mb-[35px] hidden sm:block max-md:[&_br]:hidden"
              >
                {parse(data.title)}
              </Heading>
