  ...
  return (
    <section
      className={cn(
        ...
        variant === "dwtc" && "bg-gradient-to-b from-[#fff] via-[#f1fafe] to-white sm:bg-[#F9FAFB]",
        variant === "dwtc-doc" && "bg-gradient-to-t from-[#97bdce] via-white to-white max-sm:!py-[45px_35px] xl:!py-[90px_75px]",
            ...
            {items.length > 0 && (
              ...
              >
                {items.map((item) => (
                  ...
                  >
                    <span className="absolute left-0 top-[4px] xl:top-[4px] w-[16px] 2xl:w-[18px] h-[16px] 2xl:h-[18px]">
                      {variant === "dwtc-doc" || variant === "difc-regulated" ? (
                        ...
                        >
                          <path
                            d="M10.6 5.65833L7.025 9.24167L5.65 7.86667C5.5753 7.77943 5.48337 7.70858 5.37998 7.65856C5.27659 7.60854 5.16398 7.58043 5.04921 7.576C4.93445 7.57157 4.82001 7.59091 4.71307 7.6328C4.60613 7.6747 4.50901 7.73825 4.4278 7.81946C4.34658 7.90067 4.28303 7.99779 4.24114 8.10473C4.19924 8.21167 4.17991 8.32611 4.18434 8.44088C4.18877 8.55564 4.21688 8.66826 4.2669 8.77164C4.31692 8.87503 4.38777 8.96696 4.475 9.04167L6.43334 11.0083C6.5112 11.0856 6.60355 11.1467 6.70508 11.1881C6.80661 11.2296 6.91533 11.2506 7.025 11.25C7.24362 11.2491 7.45312 11.1623 7.60834 11.0083L11.775 6.84167C11.8531 6.7642 11.9151 6.67203 11.9574 6.57048C11.9997 6.46893 12.0215 6.36001 12.0215 6.25C12.0215 6.13999 11.9997 6.03107 11.9574 5.92952C11.9151 5.82797 11.8531 5.7358 11.775 5.65833C11.6189 5.50312 11.4077 5.41601 11.1875 5.41601C10.9673 5.41601 10.7561 5.50312 10.6 5.65833ZM8.33334 0C6.68516 0 5.07399 0.488742 3.70359 1.40442C2.33318 2.3201 1.26507 3.62159 0.634341 5.1443C0.0036107 6.66702 -0.161417 8.34258 0.160126 9.95909C0.48167 11.5756 1.27534 13.0605 2.44078 14.2259C3.60622 15.3913 5.09108 16.185 6.70759 16.5065C8.32409 16.8281 9.99965 16.6631 11.5224 16.0323C13.0451 15.4016 14.3466 14.3335 15.2622 12.9631C16.1779 11.5927 16.6667 9.98151 16.6667 8.33333C16.6667 7.23898 16.4511 6.15535 16.0323 5.1443C15.6135 4.13326 14.9997 3.2146 14.2259 2.44078C13.4521 1.66696 12.5334 1.05313 11.5224 0.634337C10.5113 0.215548 9.42769 0 8.33334 0ZM8.33334 15C7.0148 15 5.72586 14.609 4.62954 13.8765C3.53321 13.1439 2.67872 12.1027 2.17414 10.8846C1.66956 9.66638 1.53753 8.32594 1.79477 7.03273C2.052 5.73953 2.68694 4.55164 3.61929 3.61929C4.55164 2.68694 5.73953 2.052 7.03274 1.79477C8.32594 1.53753 9.66639 1.66955 10.8846 2.17414C12.1027 2.67872 13.1439 3.5332 13.8765 4.62953C14.609 5.72586 15 7.01479 15 8.33333C15 10.1014 14.2976 11.7971 13.0474 13.0474C11.7971 14.2976 10.1014 15 8.33334 15Z"
                            fill="#8FD8FE"
                          />
                        </svg>
                      ) : (
