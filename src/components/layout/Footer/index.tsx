                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="relative group lg:max-w-[90%] ml-auto ">
                          ...
                          <FormItem className="space-y-0">
                            <FormControl>
                              <Input
                                ...
                                className='text-[17px] 2xl:text-[19px] 3xl:text-[21px] text-[rgba(33,33,33,0.6)] font-normal px-[5px] w-full h-full border-0 focus-visible:ring-0 focus-visible:ring-offset-0 !bg-transparent  shadow-none placeholder:text-[rgba(33,33,33,0.4)]'
                                {...field}
                              />
                            </FormControl>
                          </FormItem>
                  ...
                  <div className="absolute left-0 -bottom-6">
                    <FormField
                      ...
                      name="email"
                      render={() => (
                        <FormMessage className="text-danger text-xs font-medium" />
                      )}
                    />
                  </div>
                </form>
            ...
            <div className='lg:w-4/12 p-[10px] lg:p-[20px]  lg:pl-[70px] 2xl:pl-[90px] 3xl:pl-[115px]'>
              ...
              <ul className="space-y-[10px] 3xl:space-y-[15px]">
                <li className="flex items-center gap-3">
                  <div className="w-[19px] 2xl:w-[23px] 3xl:w-[35px] h-[19px] 2xl:h-[23px] 3xl:h-[35px] rounded-[5px] bg-white/10 flex items-center justify-center p-[5px] xl:p-[10px]">
      ...
      <div className="border-t border-white/10 py-[25px] max-sm:pb-[65px]">
        <div className="container">
          <div className="flex flex-wrap justify-center lg:justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap items-center max-sm:justify-center gap-y-2">
