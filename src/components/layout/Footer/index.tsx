            ...
            <div className="lg:w-4/12 p-[10px] lg:p-[20px]  lg:pl-[70px] 2xl:pl-[90px] 3xl:pl-[115px]">
              ...
              <ul className="space-y-[9px] ">
                <li className="flex items-center gap-3">
                  <div className="w-[23px] xl:w-[22px] xl:h-[22px] 2xl:w-[26px] 3xl:w-[35px] h-[23px] 2xl:h-[26px] 3xl:h-[35px]  rounded-[5px] bg-white/10 flex items-center justify-center p-[6px]">
