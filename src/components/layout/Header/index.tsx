          ...
          <div className="flex-1 flex items-center justify-end lg:justify-between lg:pl-[60px] xl:pl-[80px] 2xl:pl-[100px]">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden lg:block">
                <Link
                  href="/contact"
                  className="text-[14px] xl:text-[15px] 2xl:text-[17px] 3xl:text-[20px] text-[#1E1E1E] bg-[#FFC916] hover:bg-[#FFC916]/90 flex items-center justify-center font-bold px-7 py-2.5 rounded-[8px] transition-all duration-300 shadow-sm"
                >
                  Get in Touch
                </Link>
              </div>
